...
export function App() {
    ...
    return (
        <div className="w-full h-full bg-slate-800 font-sans px-8 py-4 flex flex-col gap-8 max-lg:gap-8">
            <div className="flex items-start gap-8 rounded-xl p-8 text-slate-200 bg-slate-500/5 border border-slate-700 max-lg:flex-col">
                ...
                <div>                    
                    ...
                    <p className="text-sm max-lg:mt-1">Atualmente, atuo no desenvolvimento de sistemas voltados ao suporte das demandas da área de crédito rural em bancos e cooperativas financeiras.</p>
